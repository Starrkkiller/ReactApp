...
export const Heading = () => (
  <>
    <div class="heading__wrapper">
      ...
      <div class="themes">
        <button type="button" class="button-heading">
        ...
        <div class="button-heading-theme__theme-choice">
          <p class="button-heading-theme__title">Выберите тему</p>
          <button
            type="button"
            class="button-heading button-heading__theme_position"
          >
            {/* <svg viewBox="0 0 16 16" fill="#8055FF" strok="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="8" cy="8" r="4" stroke="none"/>
            <path d="M15 9L16 8L15 7H13V9H15Z" stroke="none"/>
          ...
          <button
            type="button"
            class="button-heading button-heading__theme_position button-heading__theme_colored"
          >
