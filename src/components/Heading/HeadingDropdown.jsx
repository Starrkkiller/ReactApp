export const HeadingDropdown = () => (
  <div className="button-heading-theme__theme-choice">
    <p className="button-heading-theme__title">Выберите тему</p>
    <button
      type="button"
      className="button-heading button-heading__theme_position"
    >
    ...
    <button
      type="button"
      className="button-heading button-heading__theme_position button-heading__theme_colored"
    >
